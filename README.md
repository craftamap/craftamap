...
- [craftamap/pluploader](https://github.com/craftamap/pluploader) ([v0.8.2](https://github.com/craftamap/pluploader/releases/tag/v0.8.2), 4 days ago) - A simple plugin uploader for atlassian server tools written in python
