...
- [craftamap/netzkratzer](https://github.com/craftamap/netzkratzer) - Netzkratzer shows some simple examples for webscraping (3 days ago)
- [craftamap/bb](https://github.com/craftamap/bb) - inoffical Bitbucket.org command line tool (5 days ago)
- [craftamap/fastmac](https://github.com/craftamap/fastmac) -  (6 days ago)
- [craftamap/webscraping-generator](https://github.com/craftamap/webscraping-generator) - Various small applications/scripts that can be used for demonstrating various web scraping types (6 days ago)
...
- [livelyapps/pluploader](https://github.com/livelyapps/pluploader) ([v0.6.0](https://github.com/livelyapps/pluploader/releases/tag/v0.6.0), 1 day ago) - A simple plugin uploader for atlassian server tools written in python
- [ktrysmt/go-bitbucket](https://github.com/ktrysmt/go-bitbucket) ([v0.7.0](https://github.com/ktrysmt/go-bitbucket/releases/tag/v0.7.0), 2 days ago) - Bitbucket API library for Golang.
- [craftamap/bb](https://github.com/craftamap/bb) ([v0.1.1](https://github.com/craftamap/bb/releases/tag/v0.1.1), 1 week ago) - inoffical Bitbucket.org command line tool
