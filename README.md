...
- [ktrysmt/go-bitbucket](https://github.com/ktrysmt/go-bitbucket) ([v0.9.36](https://github.com/ktrysmt/go-bitbucket/releases/tag/v0.9.36), 4 weeks ago) - Bitbucket API library for Golang.
...
- [craftamap/atlas-gonnect](https://github.com/craftamap/atlas-gonnect) ([v0.2.1](https://github.com/craftamap/atlas-gonnect/releases/tag/v0.2.1), 7 months ago) - An Atlassian Connect Framework written in Golang
