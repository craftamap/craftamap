...
- [craftamap/esbuild-plugin-html](https://github.com/craftamap/esbuild-plugin-html) ([v0.4.0](https://github.com/craftamap/esbuild-plugin-html/releases/tag/v0.4.0), today) - esbuild plugin to generate HTML files
