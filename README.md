...
- [craftamap/shopping-list](https://github.com/craftamap/shopping-list) - A shopping list app built with deno, fresh and sqlite (2 weeks ago)
...
- [craftamap/esbuild-plugin-html](https://github.com/craftamap/esbuild-plugin-html) ([v0.4.0](https://github.com/craftamap/esbuild-plugin-html/releases/tag/v0.4.0), 4 weeks ago) - esbuild plugin to generate HTML files
