...
- [craftamap/iceportal-api](https://github.com/craftamap/iceportal-api) - iceportal-api is a Golang client implementation to interact with the REST API of iceportal.de when connected to the WiFi-Network offered in German ICE Trains. (4 days ago)
- [craftamap/wishbone](https://github.com/craftamap/wishbone) - Go Implementation of the ola sphincter-rfid (1 week ago)
- [craftamap/docker-forge-cli](https://github.com/craftamap/docker-forge-cli) -  (2 weeks ago)
...
- [ktrysmt/go-bitbucket](https://github.com/ktrysmt/go-bitbucket) ([v0.9.30](https://github.com/ktrysmt/go-bitbucket/releases/tag/v0.9.30), 2 days ago) - Bitbucket API library for Golang.
