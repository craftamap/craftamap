...
- [ktrysmt/go-bitbucket](https://github.com/ktrysmt/go-bitbucket) ([v0.9.1](https://github.com/ktrysmt/go-bitbucket/releases/tag/v0.9.1), 2 days ago) - Bitbucket API library for Golang.
- [livelyapps/pluploader](https://github.com/livelyapps/pluploader) ([v0.6.0](https://github.com/livelyapps/pluploader/releases/tag/v0.6.0), 4 weeks ago) - A simple plugin uploader for atlassian server tools written in python
