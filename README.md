...
- [craftamap/pluploader](https://github.com/craftamap/pluploader) ([v0.8.3](https://github.com/craftamap/pluploader/releases/tag/v0.8.3), 4 days ago) - A simple plugin uploader for atlassian server tools written in python
